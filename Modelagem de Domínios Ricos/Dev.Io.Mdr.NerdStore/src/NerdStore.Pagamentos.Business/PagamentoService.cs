...
namespace NerdStore.Pagamentos.Business
{
    public class PagamentoService : IPagamentoService
    {
        ...
        public async Task<Transacao> RealizarPagamentoPedido(PagamentoPedido pagamentoPedido)
        {
            ...
            {
                pagamento.AdicionarEvento(new PagamentoRealizadoEvent(pedido.Id, pagamentoPedido.ClienteId,
            ...
            await _mediatorHandler.PublicarNotificacao(new DomainNotification("pagamento",
                "A operadora recusou o pagamento"));
            await _mediatorHandler.PublicarEvento(new PagamentoRecusadoEvent(pedido.Id, pagamentoPedido.ClienteId,
                transacao.PagamentoId, transacao.Id, pedido.Valor));
